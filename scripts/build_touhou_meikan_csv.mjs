...
const NEW_ROWS = [
  ["饕餮尤魔", "", "是", "东方刚欲异闻", "", "旧血池地狱", "妖怪 > 饕餮", FIGHTING],
  ["豪德寺三花", "", "是", "东方虹龙洞", "", "妖怪之山", "妖怪 > 招财猫", "不是 > 不是"],
  ["山城高岭", "", "是", "东方虹龙洞", "", "妖怪之山", "妖怪 > 山童", "不是 > 不是"],
  ["驹草山如", "驹草太夫", "是", "东方虹龙洞", "", "妖怪之山", "妖怪 > 山女郎", "不是 > 不是"],
  ["玉造魅须丸", "", "是", "东方虹龙洞", "", "其他/不定", "神明 > 神明", "不是 > 不是"],
  ["菅牧典", "", "是", "东方虹龙洞", "", "妖怪之山", "妖怪 > 管狐", DANMAKU],
  ["饭纲丸龙", "", "是", "东方虹龙洞", "", "妖怪之山", "妖怪 > 大天狗", "不是 > 不是"],
  ["天弓千亦", "", "是", "东方虹龙洞", "", "妖怪之山", "神明 > 神明", "不是 > 不是"],
  ["姬虫百百世", "", "是", "东方虹龙洞", "", "妖怪之山", "妖怪 > 大蜈蚣", "不是 > 不是"],
  ["孙美天", "", "是", "东方兽王园", "", "妖怪之山", "妖怪 > 猿神", DANMAKU],
  ["三头慧之子", "", "是", "东方兽王园", "", "妖怪之山", "妖怪 > 山犬", DANMAKU],
  ["天火人血枪", "", "是", "东方兽王园", "", "旧血池地狱", "妖怪 > 天火人", DANMAKU],
  ["豫母都日狭美", "", "是", "东方兽王园", "", "地狱", "妖怪 > 黄泉丑女", DANMAKU],
  ["日白残无", "", "是", "东方兽王园", "", "地狱", "妖怪 > 人鬼", DANMAKU],
  ["尘塚姥芽", "", "是", "东方锦上京", "", "妖怪之山", "妖怪 > 山姥", "不是 > 不是"],
  ["封兽魑魅", "", "是", "东方锦上京", "", "妖怪之山", "妖怪 > 魑魅", "不是 > 不是"],
  ["道神驯子", "", "是", "东方锦上京", "", "地底", "神明 > 道祖神", "不是 > 不是"],
  ["维缦·浅间", "", "是", "东方锦上京", "", "地底", "神明 > 古神人", "不是 > 不是"],
  ["磐永阿梨夜", "", "是", "东方锦上京", "", "地底", "神明 > 石之女神", "不是 > 不是"],
  ["渡里贝子", "渡里妮娜", "是", "东方锦上京", "", "地底", "妖怪 > 蜃", "不是 > 不是"],
];
